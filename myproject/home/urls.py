...
urlpatterns = [
    ...
    path('rejection-simulator/<str:job_id>/', views.rejection_simulator_page, name='rejection_simulator'),
    ...
    path('ajax/resume-feedback/', views.ajax_resume_feedback, name='resume_feedback'),
    path('ajax/job-outlook/', views.ajax_job_outlook, name='job_outlook'),
    path('ajax/rejection-generator/', views.ajax_rejection_generator, name='rejection_generator'),
