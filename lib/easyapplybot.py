...
def setupLogger() -> None:
    ...
    logging.basicConfig(filename=('./logs/' + str(dt) + 'applyJobs.logger'), filemode='w',
...
class EasyApplyBot:
    ...
    def __init__(self,
        ...
        self.resume_path = resume_path or 'resume.pdf'
        ...
        self.qa_file = os.path.join(os.getcwd(), "qa.csv")
